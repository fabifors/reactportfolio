    ...
    <Container id={id} background fluid hasNestedContainer>
      <SkillSection>
        <Container>
          ...
          <Text light center>I believe that great design is essential in any product or service. I aim to create <Highlight light underline>modern</Highlight>, <Highlight light underline>simplistic</Highlight> designs that inspire people and turn your <Highlight light underline>customers</Highlight> into <Highlight light underline>followers</Highlight>. Every project I take on is very carefully planned and set-up built for the needs of my employer. Developing my skills are an essential part of this. I plow head first into projects that I have no prior experience in and treat each part of the process as a opportunity to <Highlight light underline>grow</Highlight> and <Highlight light underline>develop.</Highlight></Text>
