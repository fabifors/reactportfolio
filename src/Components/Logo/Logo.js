...
const Logo = ({ theme, click, height, footer }) => {
  ...
  const cls4 = {
    fill: (footer ? '#fff' : '#959595'),
    stroke: (footer ? '#fff' : '#959595')
  }
  ...
  const cls6 = {
    ...
    strokeLinecap: 'round',
    strokeLinejoin: 'round',
    stroke: (footer ? theme.accent.getNewHue(theme.accent.hue + 120) : theme.accent.hsl),
    strokeWidth: '8px'
  }
  ...
  return (
    <Fragment>
      {click ?
        ...
        : <svg xmlns="http://www.w3.org/2000/svg" style={style} viewBox="0 0 109 70">
          <g id="logo" transform="translate(-168 -21)">
            <rect id="binding_box" data-name="binding box" style={cls1} transform="translate(168 21)" />
            <g id="brackets" style={cls2} transform="translate(174.083 38)">
              <path id="Path_3" data-name="Path 3" style={cls3} d="M432.5,224.5,451.382,243,432.5,261.5" transform="translate(-351.715 -224.5)" />
