        ...
        <Section padding style={{ paddingBottom: '2rem' }}>
          <ContactWrapper>
            <ContactText>
              ...
              <Text light bold nomargin>
                Are you interested in learning more about me and my journey,
                hire me for your next project or just wanna{' '}
                <FooterLink
                  href="https://www.buymeacoffee.com/wJZagVhYt"
                  target="_blank"
              ...
              <Text light bold>
                Hit me up and <span>let's talk!</span>
              </Text>
              <SocialButtons />
            </ContactText>
            <Form
          ...
          <CopyrightWrapper>
            ...
            <CopyrightText>
              Handmade by{' '}
              <Highlight light bold underline>
                Fabian Forsström
              </Highlight>{' '}
              with <FontAwesomeIcon icon={['fas', 'heart']} />
            </CopyrightText>
            <a
              href="https://www.buymeacoffee.com/wJZagVhYt"
              target="_blank"
            ...
            <CopyrightText style={{ fontSize: '0.75em', fontWeight: '300' }}>
              copyright <FontAwesomeIcon icon={['fas', 'copyright']} />{' '}
              twentynineteen
            </CopyrightText>
          </CopyrightWrapper>
        </Section>
